 ...
 * @see Walker
 */
class CofCTheme_Walker_Comment extends Walker
{
    ...
    public function start_lvl(&$output, $depth = 0, $args = array())
    {
        ...
        switch ($args['style']) {
            ...
            case 'ul':
            default:
                $output .= '<ul class="children no-bullet">' . "\n";
                break;
        }
    }
        ...
        ?>
            <<?php echo $tag; ?>
                ...
                <?php if ('div' !== $args['style']): ?>
                    ...
                    ?>
                    <p class="card-news__author comment-icon">
                    ...
                    <?php if ('0' == $comment->comment_approved): ?>
                        ...
                        <br />
                    <?php endif; ?>
                    <p class="card-news__date comment-icon">
